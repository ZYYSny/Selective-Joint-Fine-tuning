#ifndef CAFFE_RANDOM_CROP_BOOSTED_DATA_LAYER_HPP_
#define CAFFE_RANDOM_CROP_BOOSTED_DATA_LAYER_HPP_
...
class RandomCropBoostedDataLayer : public BasePrefetchingDataLayer<Dtype> {
 public:
  explicit RandomCropBoostedDataLayer(const LayerParameter& param)
      : BasePrefetchingDataLayer<Dtype>(param) {}
  virtual ~RandomCropBoostedDataLayer();
  virtual void DataLayerSetUp(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);

  virtual inline const char* type() const { return "RandomCropBoostedData"; }
...
#endif  // CAFFE_RANDOM_CROP_BOOSTED_DATA_LAYER_HPP_
